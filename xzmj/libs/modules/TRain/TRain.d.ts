...
declare module cui {
    class BitmapLabel extends egret.BitmapText implements IBaseCtrl {
        ...
        $setFontData(value: RES.FontRes): boolean;
        dispose(): void;
...
declare module cui {
    class Image extends egret.Bitmap implements IBaseCtrl {
        ...
        $setTexture(value: RES.TexData): boolean;
        protected resetBitmapData(): void;
        protected contentChanged(data: RES.TexData, source: string): void;
        $onAddToStage(stage: egret.Stage, nestLevel: number): void;
...
declare module cui {
    ...
    class DataGroup extends Group {
        ...
        protected rendererAdded(renderer: DataItem): void;
        protected rendererRemoved(renderer: DataItem): void;
 ...
 */
declare module cui {
    class ImageLabel extends BitmapLabel {
        private _tex;
        protected parseFont(): void;
        private onResChanged(texData, font);
        dispose(): void;
    }
}
/**
...
declare module cui {
    class TableScroller extends Group {
         ...
         */
        showTableInViewStart(idx: number, ani: boolean | number): void;
...
declare module cui {
    ...
    class ParticleSys extends egret.DisplayObject implements IBaseCtrl {
        ...
        getTex(): RES.TexData;
        protected setTex(data: RES.TexData, source: string): void;
        $measureContentBounds(bounds: egret.Rectangle): void;
        $updateRenderNode(): void;
        /**
         * 开始创建粒子
...
declare module TRain {
    interface TexCallBack {
        (data: RES.TexData, source: string): void;
    }
    ...
    class AssetManager {
        ...
        private _imgsetList;
        constructor();
        getTex(source: string, cb: TexCallBack, tar: any, tp?: string): void;
        doGC(): void;
        getFont(name: string, cb: FontCallBack, tar: any): void;
    }
...
declare module TRain {
    ...
    class ImageSet {
        ...
        getTexture(subname: string, compFunc: (data: RES.TexData) => void, thisObject: any): void;
...
declare module TRain {
    class WebVerController implements RES.VersionController {
        ...
        addVer(key: string, ver: string): void;
        /**
         * 获取所有有变化的文件
         * @returns {Array<any>}
         */
